...
def solar_panel_sensitivity(l):
    l = np.array(l)
    p = np.array([ 3.28845414e-19, -1.46743627e-15,  2.62726044e-12, -2.40399796e-09,
        1.17350190e-06, -2.83667118e-04,  2.61414323e-02,  2.35016396e-01])
    l = l / 1e-9
    lmin = 330
    lmax = 1190
    s = np.zeros(l.shape)
...
class defaults:
    ...
    fade_margin = 20,
    sigma = 3.76,
    Isensor = np.array([0.2e-3,0.16,0.5e-3])
    Itia = 0.7e-3,
    Icca = 6.4e-3,
    IRO = 0,
    tRO = 0
